...
public class C06_DropdownTesti {
    ...
    public void dropdownTesti(){
        ...
        Select selectGun = new Select(testOtomasyonuFormPage.dropdownMenuElementList.get(0));
        selectGun.selectByIndex(5);

        //	2. Dogum tarihi ay seçeneğinden value kullanarak Nisan’i secin
        Select selectAy =new Select(testOtomasyonuFormPage.dropdownMenuElementList.get(1));
        selectAy.selectByValue("nisan");
        //	3. Dogum tarihi yil seçeneğinden visible text kullanarak 1990’i secin
        Select selectYil = new Select(testOtomasyonuFormPage.dropdownMenuElementList.get(2));

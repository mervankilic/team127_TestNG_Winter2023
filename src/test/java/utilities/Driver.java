...
public class Driver {
    ...
    /* cagirildigi yere bir WebDriver objesi dondurecek
       getDriver() olusturalim

       getDriver() her seferinde
       driver = new ChromeDriver(); satirini calistirisa
       her kullanimda yeni bir webdriver objesini olusur

       biz ilk kullanimda (yani null iken) yeni webdriver olustursun
       sonraki kullanimlarda
       atanmis deger kullanilsin
